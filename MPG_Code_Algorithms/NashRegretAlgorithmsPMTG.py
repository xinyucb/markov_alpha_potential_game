...
def compute_best_response(game, agent, policies, gamma=0.99, epsilon=9e-3, max_iters=100, num_samples=1000):
    """
...
def compute_expected_value(game, policy, gamma=0.99, agent=0, epsilon=9e-3, max_iters=100, num_samples=1000):
    """
...
# Run the experiment
game = TeamGame(3)
runs, iters, eta, T, samples, kappa, tau, gamma = 3, 100, 0.01, 20, 10, "deterministic", 0.01, 0.5
