...
def create_routing_game(
    ...
    #U is the number users which render a link unsafe 
    if seed:
        random.seed(seed)
    else:
        random.seed(100)
